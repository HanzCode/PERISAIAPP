                ...
                .addOnSuccessListener { document ->
                    if (document != null && document.exists()) {
                        try {
                            ...
                            lombaDetail = document.toObject(Lomba::class.java)?.copy(id = document.id)
                            Log.d("DetailLombaScreen", "Data detail ditemukan: ${lombaDetail?.namaLomba}")
                        } catch (e: Exception) {
            ...
            when {
                ...
                lombaDetail != null -> {
                    ...
                    Column(
                        ...
                        DetailItem(label = "Deskripsi", value = lomba.deskripsi, isLongText = true) // Tandai jika teks bisa panjang
                            ...
                            Button(
                                onClick = {
                                    ...
                                    try {
                                        ...
                                        Log.e("DetailLombaScreen", "Could not open Uri. Attempted: '$processedUrl'. Error: ${e.message}", e)
                                        // Tampilkan feedback ke user jika perlu (misal Toast)
                                    }
                                },
                                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF584ED9)),
